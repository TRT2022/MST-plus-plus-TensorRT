...
def lecun_normal_(tensor):
    ...
    # variance_scaling_(tensor, mode='fan_in')
...
class MST_Plus_Plus(nn.Module):
    def __init__(self, in_channels=3, out_channels=31, n_feat=31, stage=3):
        ...
        # self.conv_in = nn.Conv2d(in_channels, n_feat, kernel_size=3, padding=(1,4), bias=False)
    ...
    def forward(self, x):
        ...
        x = F.pad(x, [0, pad_w, 0, pad_h], "constant",0)  # <-----------padd方式改为了constant
